...
public class RecycleFrag2Adapter extends RecyclerView.Adapter<RecycleFrag2Adapter.VH> {
    ...
    public void setOnItemClick2(OnItemClickMain main) {
        RecycleFrag2Adapter.main = main;
    }
